...
import advPythonStat from "../../../../assets/CourseLogos/AdvPython/advPythonStat.png";
import check from "../../../../assets/CourseLogos/AdvPython/check.png";
import episodes from "../../../../assets/CourseLogos/AdvPython/episodes.png";
import advPython from "../../../../assets/CourseLogos/AdvPython/advPython.png";
    ...
    <div className="flex h-full w-full flex-col items-center bg-[#00AEE4] pt-[80px] font-comfortaa text-white md:pt-[110px]">
      <section className="flex w-full flex-col lg:flex-row ">
        <div className="flex w-full flex-col items-center bg-[#00AEE4]   lg:w-[70%]">
          <img src={advPython} alt="blockcoder" className=" w-full" />
