...
import arduinoStat from "../../../../assets/CourseLogos/Arduino/arduinoStat.png";
import check from "../../../../assets/CourseLogos/Arduino/check.png";
import episodes from "../../../../assets/CourseLogos/Arduino/episodes.png";
import arduino from "../../../../assets/CourseLogos/Arduino/arduino.png";
    ...
    <div className="flex h-full w-full flex-col items-center bg-[#F18E43] pt-[80px] font-comfortaa text-white md:pt-[110px]">
      <section className="flex w-full flex-col lg:flex-row ">
        <div className="flex w-full flex-col items-center bg-[#F18E43]   lg:w-[70%]">
          <img src={arduino} alt="blockcoder" className=" w-full" />
