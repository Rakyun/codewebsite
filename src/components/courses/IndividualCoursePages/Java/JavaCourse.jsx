...
import javaStat from "../../../../assets/CourseLogos/Java/javaStat.png";
import check from "../../../../assets/CourseLogos/Java/check.png";
import episodes from "../../../../assets/CourseLogos/Java/episodes.png";
import java from "../../../../assets/CourseLogos/Java/java.png";
    ...
    <div className="flex h-full w-full flex-col items-center bg-[#00AEE4] pt-[80px] font-comfortaa text-white md:pt-[110px]">
      <section className="flex w-full flex-col lg:flex-row ">
        <div className="flex w-full flex-col items-center bg-[#00AEE4]   lg:w-[70%]">
          <img src={java} alt="blockcoder" className=" w-full" />
