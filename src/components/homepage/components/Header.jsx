...
const Header = () => {
  return (
    <>
      <header className="fixed left-0 right-0 top-0 z-50 flex h-[80px] items-center justify-between bg-[#29446A] px-10 drop-shadow-lg  md:left-12 md:right-12 md:h-[110px] md:rounded-bl-[60px] md:rounded-br-[60px]">
        <img
          src={code_logo}
          alt="Logo"
